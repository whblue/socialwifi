...
Ext.define('static.app.GMapPanel', {
    ...
    setCenter: {
        lat: 31.27581099999999,
        lng: 120.72925099999998
    },
    /**
...
markers: [{
    ...
    initComponent: function () {
        ...
        static.app.GMapPanel.superclass.initComponent.call(this);
        ...
        if (this.rendered) {
            ...
            Ext.defer(function () {
                if (this.gmapType === 'map') {
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function (response, options) {
                        	...
                        	Ext.Array.each(res, function (name, i, it) {
                        		point = new google.maps.LatLng(name.longitude, name.latitude);
                                marker = new google.maps.Marker(point);
                                //alert(point.longitude+"in"+point.latitude);
                                new google.maps.event.addListener(marker, 'click', function () {

                                	
                                    var infowindow = new google.maps.InfoWindow({
                                        content: "latitude:"+point.lat()+" longtitude:"+point.lng()
                                    });
                                   // alert(this.gmap);
                                    infowindow.open(ma, marker);
                                   // Ext.getCmp('ip1').setRawValue("192.168.1.126");
                                });
                                //ma.addOverlay(marker);
                                u.addMarker(point, marker, false, false);
                        	});
                        }
                     });
                	else{
                            ...
                            success: function (response, options) {
                            	...
                            	Ext.Array.each(res, function (name, i, it) {
                                    ...
                                    new google.maps.event.addListener(marker, 'click', function () {
                                       ...
                                       // alert(this.gmap);
                                        infowindow.open(ma, marker);
                                        Ext.getCmp('ip1').setRawValue(name.IP);
                                    });
                                    //ma.addOverlay(marker);
                                    u.addMarker(point, marker, false, false);
                            	});
                    ...
                    /*var point = new google.maps.LatLng(31.3, 120.0);
                    ...
                    //alert(ma+"ma")
                        	...
                        	/* var point= new google.maps.LatLng(31.3, 120);
                             var marker = new google.maps.Marker(point1);
                             new google.maps.event.addListener(marker, 'click', function () {
                                 var s2="latitude:" + point.lat() + " longtitude:118" ;
                                 var infowindow = new google.maps.InfoWindow({
                                     content: s2
                                 });
                                 // alert(this.gmap);
                    ...
                    var point1 = new google.maps.LatLng(30.0, 118);
                    var marker1 = new google.maps.Marker(point1);
                    new google.maps.event.addListener(marker1, 'click', function () {
                        var s2="latitude:" + point1.lat() + " longtitude:118" ;
                        var infowindow1 = new google.maps.InfoWindow({
                            content: s2
                        });
                        // alert(this.gmap);
                        infowindow1.open(ma, marker1);
                        Ext.getCmp('ip1').setRawValue("192.168.1.134");
                    });
                    
                    this.addMarker(point1, marker1, false, false);
                   alert(Ext.getCmp('ip1')+"pq");*/
                }
    ...
    afterRender: function () {
        ...
        Ext.applyIf(this, wh);
        static.app.GMapPanel.superclass.afterRender.call(this);
    ...
    onResize: function (w, h) {
        ...
        static.app.GMapPanel.superclass.onResize.call(this, w, h);
    ...
    setSize: function (width, height, animate) {
        ...
        static.app.GMapPanel.superclass.setSize.call(this, width, height, animate);
    ...
    addMarker: function (point, marker, clear, center, listeners) {
       ...
       // alert(point.LatLng);
        ...
        //alert(this.gmap + "this");
        mark.setMap(this.gmap);
